  ...
  <b-container fluid class="bg-info p-0">
    ...
    <b-navbar toggleable="lg" type="dark" variant="info" class="container">
      <b-navbar-brand :to="{ path: '/' }">
        ...
        >
          <g transform="matrix(1,0,0,1,-3.65644,-10.961)">
            <g transform="matrix(1.39038,0,0,1.39038,-32.2133,-0.218028)">
              <g
                transform="matrix(2.11644,2.22045e-16,-2.22045e-16,2.11644,-149.851,-60.4296)"
              >
                <path
                  d="M109.487,42.34L112.801,45.654L99.57,58.885L89.628,48.942L92.942,45.628L99.57,52.256L109.487,42.34Z"
                  style="fill:rgb(0,204,89);"
                />
              </g>
              <g
                transform="matrix(2.11644,2.22045e-16,-2.22045e-16,2.11644,-163.895,-88.5292)"
              >
                <path
                  d="M106.199,45.628L109.513,48.942L102.885,55.57L109.513,62.199L106.199,65.513L99.57,58.885L92.942,65.513L89.628,62.199L96.256,55.57L89.628,48.942L92.942,45.628L99.57,52.256L106.199,45.628Z"
                  style="fill:rgb(236,81,0);"
                />
              </g>
            </g>
          </g>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item :to="{ name: 'Ranking' }">
            <span class="text-white"><strong>Classement</strong></span>
          </b-nav-item>
        </b-navbar-nav>
        <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown right>
            ...
            <template v-else v-slot:button-content>
              <span class="text-white">{{ loggedName }}</span>
            </template>
